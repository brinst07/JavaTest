/*[ 연습문제 ]
	...
	[연습문제]/ch3/Exercise3_2.java
		...
		1. 형변환으로 해결
		(int)(((float)numOfApples/sizeOfBucket)+0.9)
		2. 삼항연산자으로 해결
	...
	[연습문제]/ch3/Exercise3_7.java
		...
		(int)((5/9f * (fahrenheit-32))*100+0.5f)/100.0f
	...
	[연습문제]/ch3/Exercise3_9.java
		...
		boolean b1 = ((ch>='A'&&ch<='Z')||(ch>='a'&&ch<='z')||(ch>=0&&ch<=9)  );
